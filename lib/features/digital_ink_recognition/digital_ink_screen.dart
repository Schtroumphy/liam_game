...
// BCP-47 Code from https://developers.google.com/ml-kit/vision/digital-ink-recognition/base-models?hl=en#text
const frLanguageCode = "fr-FR";

class DigitalInkScreen extends StatefulWidget {
  const DigitalInkScreen({Key? key}) : super(key: key);
